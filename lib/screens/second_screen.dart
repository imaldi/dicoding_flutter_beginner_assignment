          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                  onPressed: () {
                    setState(() {
                      numberValue = int.parse(textEditingController.text) *
              ...
              Container(
                child: Builder(builder: (c) {
                  var listMakananFavoriteAldi =
                      json.decode(jsonExample)['makanan_favorit'];
                  return ListView.builder(
                      ...
                      itemBuilder: (c, i) {
                        return ListTile(
                          tileColor:
                              i % 2 == 0 ? Colors.green : Colors.lightGreen,
                          title: Text(
                              "${listMakananFavoriteAldi[i]["nama_makanan"]}"),
                        );
                      });
